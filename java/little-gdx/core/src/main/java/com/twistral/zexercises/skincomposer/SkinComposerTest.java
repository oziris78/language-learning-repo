package com.twistral.zexercises.skincomposer;
...
public class SkinComposerTest implements ApplicationListener {
    ...
    public void create() {
        ...
        Skin skin = new FreeTypeSkin(Gdx.files.internal("skinComposerTest/twSkin/out/tw-skin.json"));
//        Skin skin = new FreeTypeSkin(Gdx.files.internal("skinComposerTest/twSkin2/out/tw-skin.json"));
